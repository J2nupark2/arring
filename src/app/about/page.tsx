...
export const metadata: Metadata = {
  title: "서비스 소개",
  description:
    "Arring이 아이온2 파티 자동매칭에서 투력, 기믹 진도, 클래스 조합, 플레이어 평가를 활용하는 방식입니다.",
  ...
  return (
    <main className="mx-auto flex w-full max-w-4xl flex-1 flex-col gap-8 px-4 py-12 sm:px-6">
      ...
      <section className="space-y-4">
        <h1 className="text-3xl font-bold tracking-tight">아이온2 파티 매칭을 더 선명하게</h1>
      ...
      <section className="grid gap-4 md:grid-cols-2">
        <article className="rounded-md border p-4">
          ...
          <p className="mt-2 text-sm leading-6 text-muted-foreground">
            ...
            우선합니다. 투력은 최소 조건 이상을 기준으로 하되, 가능하면 비슷한
        ...
        <article className="rounded-md border p-4">
          ...
          <p className="mt-2 text-sm leading-6 text-muted-foreground">
            매칭 후 평가는 파티 품질을 높이기 위한 참고 자료입니다. 매너 점수와
