...
create table public.aion2_characters (
  ...
  stat_list jsonb not null default '[]'::jsonb,
  titles jsonb not null default '[]'::jsonb,
  daevanion jsonb not null default '[]'::jsonb,
...
-- class stat priority --------------------------------------------------
-- Admin-curated soul/stone engraving priority per class. There's no
-- official damage formula to compute real efficiency from, so this is a
-- qualitative 1-4 tier ranking, not a calculated value.
